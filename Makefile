...
else ifeq ($(COIN),shibainucoin)
# SHIC
BIP44_COIN_TYPE=74 
BIP44_COIN_TYPE_2=74 
COIN_P2PKH_VERSION=63 
COIN_P2SH_VERSION=22 
COIN_FAMILY=1 
COIN_COINID=\"Shibainucoin\" 
COIN_COINID_NAME="Shic"
COIN_COINID_SHORT=\"SHIC\" 
COIN_KIND=COIN_KIND_SHIC
APPNAME ="Shibainucoin"
